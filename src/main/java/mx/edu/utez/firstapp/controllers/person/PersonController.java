...
public class PersonController {
    ...
    insert(@RequestBody PersonDto person) { // @RequestBody is used to bind the HTTP request body with a domain object in method parameter or return type and BindingResult is used to validate the request body
        return new ResponseEntity<>(
